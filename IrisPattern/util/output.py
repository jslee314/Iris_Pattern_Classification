...
from IrisPattern.util.showtrain import hist_saved, confusion_matrix_saved
...
def makeoutput(x_val, y_val, model, hist, classes):
    ...
    target_names = ["defect_output_loss", "lacuna_output_loss", "spoke_output_loss", "spot_output_loss", ]
