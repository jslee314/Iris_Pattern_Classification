...
h5_weights_path = 'output/smallvgg_defect_resize_200_32/modelsaved/h5/smallvgg_defect_resize_200_32_weights.h5'
...
for i, prediction in enumerate(preds):
    ...
    (prob, normal) = (preds[i][0], preds[i][1])

    label = "{}: {:.2f}%".format('defect', prob * 100)
    print("label / i: " + label +" / "+str(classIdx))
    ...
    cv2.putText(output, label, (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (255, 255, 255), 1)
